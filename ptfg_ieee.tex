...
\subsection{Síntomas del Trastorno del Espectro Autista}~\\
...
\end{table}
\textbf{Fuente:} Ministerio de Salud Pública y Bienestar Social, Protocolo para la atención del trastorno del espectro autista en Paraguay, 2023.
\subsection{Inteligencia Artificial}
\subsubsection{Definición y fundamentos}
La Inteligencia Artificial se definirá como el campo de la ciencia computacional dedicado al desarrollo de sistemas capaces de realizar tareas que tradicionalmente requerirían de la inteligencia humana, tales como el razonamiento, el aprendizaje y la percepción visual \cite{russell_norvig_ai_2020}. En el ámbito de la ingeniería, la IA presentará una evolución significativa, pasando de sistemas basados en reglas lógicas hacia modelos capaces de extraer conocimiento directamente a partir de los datos \cite{mitchell_ml_1997}. Esta transformación permitirá que la disciplina deje de depender de heurísticas rígidas y se consolide como un marco robusto de aprendizaje estadístico y computacional.
\subsubsection{ Ramas de la IA aplicadas a la ingeniería}
Actualmente, la Inteligencia Artificial se dividirá en diversas áreas de especialización, destacándose el Aprendizaje Automático (Machine Learning) y el Aprendizaje Profundo (Deep Learning) como las ramas de mayor impacto en la ingeniería moderna. Estos enfoques permitirán a los sistemas no solo procesar información, sino también aprender de grandes volúmenes de datos y generalizar soluciones a partir de patrones complejos \cite{goodfellow_dl_2016}. En el área de la salud, estas capacidades facilitarán la identificación de biomarcadores y patrones conductuales que resultarán imperceptibles mediante métodos tradicionales, posicionando a la IA como una herramienta clave de apoyo en el diagnóstico clínico \cite{sherkatghanad_autism_2020}.


\subsection{Aprendizaje automático}
\subsubsection{ Definición y fundamentos}
El Aprendizaje Automático constituirá una subdisciplina fundamental dentro del campo de la Inteligencia Artificial, cuyo propósito será desarrollar modelos capaces de aprender patrones a partir de datos sin ser programados de forma explícita para cada tarea. En este sentido, los algoritmos permitirán identificar relaciones complejas dentro de grandes volúmenes de información, facilitando la automatización de procesos de análisis y toma de decisiones \cite{bishop_prml_2006}.
Los fundamentos del aprendizaje automático se basarán en el uso de datos de entrada, modelos matemáticos y procesos de entrenamiento mediante los cuales el sistema ajustará sus parámetros internos con el objetivo de minimizar el error. Este proceso implicará el uso de funciones de pérdida y algoritmos de optimización, así como técnicas de validación para garantizar la capacidad de generalización del modelo frente a datos no vistos previamente \cite{goodfellow_dl_2016_v2}.
...
\section{Método}
Desde el enfoque metodológico, se enmarcará como aplicada y de desarrollo tecnológico, con enfoque cuantitativo y alcance descriptivo-evaluativo. La propuesta buscará construir y evaluar un prototipo web capaz de analizar secuencias de video para identificar patrones conductuales repetitivos asociados al Trastorno del Espectro Autista mediante una arquitectura CNN-LSTM.

El análisis se centrará en tres conductas visualmente observables: aleteo de manos, balanceo corporal y movimientos repetitivos de cabeza. Estas conductas serán consideradas como clases de análisis dentro del modelo, sin que ello implique la emisión de un diagnóstico clínico definitivo. El sistema funcionará como una herramienta de apoyo para el registro y análisis preliminar de patrones conductuales.

La evaluación se realizará mediante métricas técnicas de desempeño, como precisión, recall y F1-score, además de pruebas funcionales del prototipo web. Estas pruebas permitirán verificar la carga de videos, el procesamiento de fotogramas, la integración del modelo y la presentación de resultados al usuario. 


\subsection{Especificaciones de diseño}
 La especificación del diseño metodológico se orientará al desarrollo de un prototipo web de apoyo para la identificación de patrones conductuales asociados al Trastorno del Espectro Autista mediante una arquitectura CNN-LSTM. El sistema analizará secuencias de video con el propósito de reconocer tres conductas repetitivas visualmente observables: aleteo de manos, balanceo corporal y movimientos repetitivos de cabeza, conforme a la delimitación planteada en el anteproyecto.
El diseño será no experimental, debido a que no se intervendrá sobre pacientes ni se modificarán condiciones clínicas. El análisis se realizará a partir de videos previamente seleccionados y etiquetados, los cuales servirán como fuente de datos para el entrenamiento y evaluación del modelo. Por tanto, la propuesta no buscará establecer un diagnóstico clínico definitivo, sino apoyar la identificación preliminar de patrones conductuales que puedan orientar una posterior evaluación profesional.
Desde el punto de vista técnico, el diseño contemplará cinco componentes principales: organización del conjunto de videos, preprocesamiento de fotogramas, construcción del modelo CNN-LSTM, evaluación del desempeño e integración del modelo en una plataforma web. En la primera etapa, los videos serán clasificados según la conducta predominante observada. Posteriormente, se extraerán fotogramas, se normalizarán las imágenes y se prepararán las secuencias para su procesamiento computacional.
La arquitectura CNN-LSTM será utilizada porque permite combinar el análisis espacial y temporal de los videos. La red CNN extraerá características visuales de cada fotograma, como postura, posición de manos, cabeza y cuerpo. Luego, la red LSTM procesará la secuencia temporal de esas características para identificar patrones repetitivos a lo largo del video.
...
\begin{figure}[htbp]
    ...
    \label{fig:web_tea}
\end{figure}
\textbf{Fuente: Elaboración propia mediante herramientas de inteligencia artificial.}

La Figura 1 presenta la arquitectura funcional propuesta para el sistema web de apoyo a la identificación de patrones conductuales asociados al Trastorno del Espectro Autista. El flujo inicia en el cliente o frontend, donde el usuario podrá cargar secuencias de video y visualizar el estado del procesamiento y los resultados generados por el sistema.
...
La validación del funcionamiento del sistema deberá ser realizada por un profesional vinculado al área del TEA, como un especialista en salud mental, pediatría, neurología infantil, psicología clínica o desarrollo infantil. Esta validación tendrá carácter preliminar y no reemplazará el diagnóstico clínico profesional.




\subsection{Lista de tareas}
Las tareas se organizan en correspondencia con los objetivos específicos del anteproyecto, de modo que cada objetivo cuente con actividades concretas para su cumplimiento. Esta organización permite mantener la trazabilidad entre los objetivos, el desarrollo metodológico y los productos esperados del sistema web basado en arquitectura CNN-LSTM para la identificación de patrones conductuales asociados al TEA. 
...
\begin{enumerate}[label=\alph*]
    \item Entrenamiento del modelo CNN-LSTM con el conjunto de datos preparado.
...
\begin{enumerate}[label=\alph*]
    ...
    \item Registro y análisis de los resultados obtenidos por el sistema. 
\end{enumerate}
...
\textbf{Objetivo 7:} Elaborar plataforma web.
&
a) Diseño e implementación de interfaz web.
&
&
&
&
...
\item \textbf{Balanceo corporal:} Conducta motora repetitiva asociada al TEA, observable en videos mediante movimientos reiterados del cuerpo hacia adelante, hacia atrás o hacia los lados. Esta variable se vincula con la organización del dataset y con el entrenamiento del modelo.
...
\item \textbf{Tecnología aplicada al TEA:} Recursos tecnológicos utilizados para el análisis automatizado de patrones conductuales en videos, considerando visión artificial, redes CNN, redes LSTM y arquitectura híbrida CNN-LSTM. Esta variable se relaciona con el objetivo orientado a adquirir conocimiento sobre la tecnología CNN-LSTM aplicada al TEA.

\textbf{Estimador:} Marco teórico elaborado y cuadro comparativo de tecnologías aplicables al análisis de patrones conductuales.

\item \textbf{Herramienta de video:} Conjunto de videos utilizados como fuente de datos para observar, etiquetar y procesar conductas repetitivas visualmente identificables. Esta variable se relaciona con la recolección, organización y preprocesamiento del conjunto de datos.

\textbf{Estimador:} Número de videos seleccionados, duración, formato, calidad visual, clase asignada y cantidad de fotogramas extraídos.
...
\item \textbf{Forma de evaluación profesional:} Revisión preliminar de los resultados generados por el sistema, realizada por un profesional vinculado al área del TEA, con el propósito de valorar si las conductas identificadas por el modelo son coherentes con las observaciones esperadas.

\textbf{Estimador:} Ficha de evaluación profesional, observaciones registradas y coincidencia entre la conducta identificada por el sistema y la valoración del profesional.
...
&
Tecnología aplicada al TEA.
&
Marco teórico elaborado y cuadro comparativo de tecnologías aplicables al problema.
\\
\hline
...
&
Cantidad de videos seleccionados, duración, formato, calidad visual y clases etiquetadas.
\\
\hline
...
&
Arquitectura definida del modelo CNN-LSTM, tasa de aprendizaje, número de épocas y tamaño del lote.
\\
\hline
...
b) Normalización y ajuste de imágenes para el entrenamiento.
&
Herramienta de video.
&
Cantidad de fotogramas extraídos, resolución de imágenes y proporción de datos preprocesados.
\\
\hline
...
Algoritmo de reconocimiento del TEA.
&
Registro técnico del entrenamiento y configuración final del modelo.
\\
\hline
...
b) Análisis de resultados por clase.
&
Aleteo de manos.
&
Valor de precisión, recall y F1-score en la identificación del aleteo de manos.
\\
\hline
...
Balanceo corporal.
&
Valor de precisión, recall y F1-score en la identificación del balanceo corporal.
\\
\hline
...
&
Valor de precisión, recall y F1-score en la identificación de movimientos repetitivos de cabeza.
\\
\hline
...
Tecnología aplicada al TEA.
&
Funcionamiento de la plataforma web e integración operativa del modelo en el sistema.
\\
\hline
...
b) Registro y análisis de resultados.
&
Forma de evaluación profesional.
&
Ficha de validación profesional, observaciones registradas y concordancia con los resultados del sistema.
\\
\hline
